...
public class Controller extends HttpServlet {
	...
	private void gerarRelatorioPdf(HttpServletResponse response, String data, double volumeLitros, String tipo,
	    ...
	    try {
	        ...
	        document.add(tabela);
	        document.add(new Paragraph("Nota: Os valores de energia e transformidade não são somados. A linha TOTAL refere-se apenas à emergia total por litro."));

	        document.add(new Paragraph("Fonte: Adaptado de Odum (1996), Pereira (2008), Brown et al."));
